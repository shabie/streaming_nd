...
def configure_connector():
    ...
    #
    #       See: docs.confluent.io/current/connect/references/restapi.html
    #       See: docs.confluent.io/current/connect/kafka-connect-jdbc/source-connector/source_config_options.html
    #
    resp = rest_method(
        KAFKA_CONNECT_URL,
